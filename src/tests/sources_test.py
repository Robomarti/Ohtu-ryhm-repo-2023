...
class SourcesTestCase(unittest.TestCase):
    ...
    def test_delete_book_when_not_login(self):
        result = sources.delete_source("books", 1)
        self.assertEqual(result, False)
    ...
    def test_delete_article_when_not_login(self):
        result = sources.delete_source("articles", 1)
        self.assertEqual(result, False)
    ...
    def test_delete_inproceeding_when_not_login(self):
        result = sources.delete_source("inproceedings", 1)
        self.assertEqual(result, False)
    ...
    def test_delete_unknown_source_type(self):
        session["user_id"] = 1
        result = sources.delete_source("movies", 1)
        self.assertEqual(result, False)
    ...
    def test_delete_unknown_source_id(self):
        session["user_id"] = 1
        result = sources.delete_source("books", 5)
        self.assertEqual(result, True)
    ...
    def test_delete_bad_params(self):
        session["user_id"] = 1
        result = sources.delete_source("books", "articles")
        self.assertEqual(result, True)
    ...
    @patch('sources.db.session.commit', side_effect = Exception("Simulated error"))
    def test_add_book_with_mock_exception(self, mock_commit):
        session["user_id"] = 1
        result = sources.add_book(
            'Book Tester 3', 
            'Testbook3', 
    ...
    @patch('sources.db.session.commit', side_effect = Exception("Simulated error"))
    def test_add_article_with_mock_exception(self, mock_commit):
        session["user_id"] = 1
        result = sources.add_article(
            'Test Article Writer 3', 
            'Test article 3', 
    ...
    @patch('sources.db.session.commit', side_effect = Exception("Simulated error"))
    def test_add_inproceedings_with_mock_exception(self, mock_commit):
        session["user_id"] = 1
        result = sources.add_inproceedings(
                            'Author3',
                            'Inproceedings no. 3',
    ...
    @patch('sources.db.session.commit', side_effect = Exception("Simulated error"))
    def test_delete_source_with_mock_exception(self, mock_commit):
        session["user_id"] = 1
        result = sources.delete_source('books', 1)
        self.assertEqual(result, False)
